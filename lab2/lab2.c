...
typedef struct {
  ...
  unsigned char part_type;/* 0x83 - primary part, 0x05 - extended part */
...
/* CHS of part last sector, sectors enumerated from one */
  ...
  unsigned int abs_start_sec;/* absolute sector number */
  unsigned int sec_in_part;/* number of sectors in part */
} PartEntry;
